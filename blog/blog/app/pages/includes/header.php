    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
          ...
          <img class="bi me-2 rounded-circle shadow" src="<?=ROOT?>/assets/images/logo.webp"  width="60" height="52" style="object-fit:cover;">
        </a>
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="<?=ROOT?>/login" class="nav-link px-2  <?=$url[0] =='signin' ? 'link-primary':'link-dark'?>">Sign in</a></li>
          <li>
